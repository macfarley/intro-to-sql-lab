...
SELECT *
FROM countrylanguages
WHERE language = 'Italian' AND percentage = 100.0;
SELECT name
FROM countries
WHERE code = 'SMR';
...
SELECT *
FROM cities
WHERE name ILIKE 'Serra%' AND countrycode != 'SMR';
SELECT name
FROM countries
WHERE code = 'BRA';
...
-- Final query, destination city will have a population of 91085-1 from Carmen's note.
-- Sanity check it will be somewhere "sunny"
SELECT *
FROM cities
